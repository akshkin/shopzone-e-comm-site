...
function ProductDetail(){
    ...
    const {allProducts, addToFavorites, removeFromFavorites, addToCart} = useContext(Context)
    const thisProduct = allProducts.find(product => product.id.toString() === productId)
