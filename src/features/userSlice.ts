...
export const signInUser = createAsyncThunk("user/signIn", async (formFields: FormFields) => {
  try {
...
export const signUpUser = createAsyncThunk("user/signUp", async (formFields: FormFields) => {
  try {
